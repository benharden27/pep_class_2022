...
The class will begin on June 6 and run until July 1.
...
The class will be mostly **flexibly-paced**, meaning you are largely free to move through the content and exercises when it suits you. My reasons for this are to help you:
...
The only scheduled parts of the class will be various discussions, group meetings, check-ins, and guest speakers. More on that structure below and in the [calendar]().
...
I will be available for immediate feedback and discussion during the daily class period (9am-12pm, see below). Please speak up if you need our support, but be patient as we try to meet the needs of the whole PEP cohort. If there are enough questions or interest in a particular topic then we will arrange small group instruction.
...
We're going to be framing all of our learning around one team-based research project. Your project team will examine data collected on our research cruise at the start of the program and follow a similar structure to that of your summer-long research internship.

To break this research process down, we will be focusing on the following assignments and associated skill sets:
...
* **Data Report**
  ...
  * Determining appropriate plot types
  * Testing hypotheses
  * Writing a report
...
* **Reflection Portfolio**
  * Understanding yourself as a scientist
  * Collaborating with others
  * Placing your science in the community

At the beginning of the class I will ask you to reflect on your experiences and comfort with each of these skills. That will form the basis of our initial discussion of how you would like to grow.

You can see the full list of topics, modules and levels on the [classes](../classes/) page.

### Levels

Each skill in assignment has four associated levels to achieve. In most scenarios thse levels will look like this: 
...
Level 2: This level will typocally ask you to apply the skill in a new, real-world scenario. Success at this level is where I would hope most of you can get to in each of the skills by the end of the class. 
...
Level 4: This is an advanced level that will be constructed in conference with me if you are clearly demonstrating mastery at level 3 due to previous experiences.

### Grades

At the beginning of the class I will ask you to review the class skills rubric. Once you are clear on the expectations of each level I will ask you to assess you current attainment level with each. This might vary a lot over the range of topics, but please be honest - zero experience is a totally acceptable answer: we are not here to judge you, only to help you be successful.

As stated above, my goal for this class is to have everyone achieve level 2 status in all skills by the end. After you've assessed where you are, I'm going to ask you make a plan for where you'd like to be. For those with less experience that might be bringing yourself up to Level 2 across the board. For others with broader experience it may be selecting a few skills to advance to level 3 or 4. For most of you it will probably be some combination of bringing some new skills to level 2 whilst progressing established skills.

Once you've completed this self-assessment, I'll work with you to determine if your plan is achievable. We'll have a chance to review this mid-term, but the basic idea is that if you meet the goals set out then it's an A. Partial fulfillment is a b, and little demonstrated progress a C.

### Staying On-pace

You are free to move at a pace that suits you for the most part. However, there will be a number of fixed-point assessments, discussions and presentations. These will be generally tied to the completion of each assignment - you should keep an eye on the dates/times of these so you can make sure you move through your levels in time to fully participate.
...
Class will be from 9am - 12pm daily with a couple of exceptions. In this period we'll have both synchronous and asynchronous class work. I will be available to you during this time and we expect you to be available for full-class, small group and individual interaction as needed.

Outside of the 9am - 12pm window, I will also be available to field questions and offer assistance asynchronously until 7pm. Please post your questions in the #class Slack Channel and be patient for a reply. Remember, your peers will often be a great resource for you - please work together if you like, but remember to only submit your own work (see policy on academic accuracy in the syllabus).
